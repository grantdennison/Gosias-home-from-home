...
/* Subject and Email Variables */
	...
	$webMaster = 'gosiashomefromhome@yahoo.co.uk';
	
/* Gathering Data Variables */

	$nameField = $_POST['Name'];
	$emailField = $_POST['Date'];
...
<meta HTTP-EQUIV="REFRESH" content="0; url=http://www.gosiashomefromhome.co.uk/comment_thanks.html">
<style type="text/css">
<!--
body {
